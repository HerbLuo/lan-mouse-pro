...
fn request_accessibility_permission() -> bool {
    ...
    // startup (see the web frontend's macOS TCC handling).
            ...
            Event::Pointer(pointer_event) => {
                match pointer_event {
                    ...
                    PointerEvent::Axis {
                        ...
                        // Wire convention: positive axis 0 = content moves down
                        // (matches Windows/Linux). macOS CGEvent axis 1
                        // positive = content moves up, so flip the vertical
                        // sign here. Horizontal axis already matches the wire
                    ...
                    PointerEvent::AxisDiscrete120 { axis, value } => {
                        ...
                        // See Axis branch above: wire vertical positive = content
                        // moves down, but macOS CGEvent vertical positive = up,
